...
#dataset = pd.read_csv("/home/berk/VS_Project/simglucose/examples/trajectories/DATA_eps_1-2022-11-07 11:28:00.csv")
...
class DecisionTransformerGymDataCollator:
    ...
    def __init__(self, dataset) -> None:
        self.act_dim = len(dataset["actions"])
        self.state_dim = len(dataset["observations"])
