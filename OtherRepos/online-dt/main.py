...
import os
# Set the D4RL_SUPPRESS_IMPORT_ERROR environment variable to 1
os.environ['D4RL_SUPPRESS_IMPORT_ERROR'] = '1'
# Now you can import d4rl without raising import errors
import d4rl
...
class Experiment:
    ...
    def _get_env_spec(self, variant):
        if variant["env"] == "simglucose-adult-v1":
            register(
            id='simglucose-adult-v1',
            entry_point='simglucose.envs:T1DSimEnv',
            kwargs={'patient_name': 'adult#001',}
            )
            self.env = gym.make(variant["env"])
        else:
            self.env = gym.make(variant["env"])
    ...
    def _load_dataset(self, env_name):
        ...
        # dataset_path = f"/home/berk/VS_Projects/simglucose/examples/trajectories/DATA_eps_5-2022-11-12 22:28:00.pkl"
        dataset_path = f"/home/berk/VS_Projects/simglucose/exercise/notebooks/PPO_traj_4800_step.pkl"
        # dataset_path = f"/home/berk/VS_Projects/simglucose/online-dt/data/hopper-medium-v2.pkl"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="simglucose-adult-v1")
    ...
    parser.add_argument("--num_updates_per_pretrain_iter", type=int, default=10)

    # finetuning options
    parser.add_argument("--max_online_iters", type=int, default=1)
    parser.add_argument("--online_rtg", type=int, default=20)
    parser.add_argument("--num_online_rollouts", type=int, default=1)
    parser.add_argument("--replay_size", type=int, default=1000)
    parser.add_argument("--num_updates_per_online_iter", type=int, default=10)
